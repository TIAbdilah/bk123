...
//        $this->load->view('admin/index', $data);
    ...
    public function process($action, $id = null) {
        ...
        $data['sosial_budaya_kt'] = $this->input->post('inpSosBud_ft');
...
//            $data['ketidakteraturan_bangunan_foto'] = $this->upload_image(array('indikator_name' => 'ket_bang_' . substr($data['kategori'], 0, 4), 'input' => 'inpKetBang_ft', 'id_kaw_kumuh' => $data['id_kaw_kumuh']));
//            $data['tingkat_kepadatan_bangunan_foto'] = $this->upload_image(array('indikator_name' => 'kep_bang_' . substr($data['kategori'], 0, 4), 'input' => 'inpKepBang_ft', 'id_kaw_kumuh' => $data['id_kaw_kumuh']));
//            $data['ketidaksesuaian_dg_persy_te_be_foto'] = $this->upload_image(array('indikator_name' => 'ket_pete_bang_' . substr($data['kategori'], 0, 4), 'input' => 'inpKetPeTeBang_ft', 'id_kaw_kumuh' => $data['id_kaw_kumuh']));
//            $data['cakupan_pelayanan_jalan_foto'] = $this->upload_image(array('indikator_name' => 'cak_pel_jal_' . substr($data['kategori'], 0, 4), 'input' => 'inpCakPelJal_ft', 'id_kaw_kumuh' => $data['id_kaw_kumuh']));
//            $data['kualitas_permukaan_jalan_foto'] = $this->upload_image(array('indikator_name' => 'kua_per_jal' . substr($data['kategori'], 0, 4), 'input' => 'inpinpKuaPerJal_ft', 'id_kaw_kumuh' => $data['id_kaw_kumuh']));
//            $data['akses_air_minum_foto'] = $this->upload_image(array('indikator_name' => 'ket_aks_air_min_' . substr($data['kategori'], 0, 4), 'input' => 'inpKetAksAirMin_ft', 'id_kaw_kumuh' => $data['id_kaw_kumuh']));
//            $data['tidak_terpenuhi_kebutuhan_air_foto'] = $this->upload_image(array('indikator_name' => 'tid_ter_keb_air_' . substr($data['kategori'], 0, 4), 'input' => 'inpTidTerKebAir_ft', 'id_kaw_kumuh' => $data['id_kaw_kumuh']));
//            $data['tidak_mampu_mengalirkan_air_foto'] = $this->upload_image(array('indikator_name' => 'ket_men_lim_air_' . substr($data['kategori'], 0, 4), 'input' => 'inpKetMenLimAir_ft', 'id_kaw_kumuh' => $data['id_kaw_kumuh']));
//            $data['tidak_tersedia_drainase_foto'] = $this->upload_image(array('indikator_name' => 'tid_ter_dra_' . substr($data['kategori'], 0, 4), 'input' => 'inpKetDra_ft', 'id_kaw_kumuh' => $data['id_kaw_kumuh']));
//            $data['tidak_terhubung_sistem_drainase_foto'] = $this->upload_image(array('indikator_name' => 'tid_ter_sis_dra_' . substr($data['kategori'], 0, 4), 'input' => 'inpKetSisDra_ft', 'id_kaw_kumuh' => $data['id_kaw_kumuh']));
//            $data['tidak_terpelihara_drainase_foto'] = $this->upload_image(array('indikator_name' => 'tid_ter_dra_' . substr($data['kategori'], 0, 4), 'input' => 'inpKetPelDra_ft', 'id_kaw_kumuh' => $data['id_kaw_kumuh']));
//            $data['kualitas_konstruksi_drainase_foto'] = $this->upload_image(array('indikator_name' => 'kua_kon_dra_' . substr($data['kategori'], 0, 4), 'input' => 'inpKuaKonDra_ft', 'id_kaw_kumuh' => $data['id_kaw_kumuh']));
//            $data['sistem_pengelolaan_air_limbah_foto'] = $this->upload_image(array('indikator_name' => 'sis_pen_air_lim_' . substr($data['kategori'], 0, 4), 'input' => 'inpSisPenAirLim_ft', 'id_kaw_kumuh' => $data['id_kaw_kumuh']));
//            $data['pras_pengelolaan_air_limbah_foto'] = $this->upload_image(array('indikator_name' => 'pra_pen_air_lim_' . substr($data['kategori'], 0, 4), 'input' => 'inpPraPenAirLim_ft', 'id_kaw_kumuh' => $data['id_kaw_kumuh']));
//            $data['pras_sampah_tidak_sesuai_foto'] = $this->upload_image(array('indikator_name' => 'pra_per_sam_tid_' . substr($data['kategori'], 0, 4), 'input' => 'inpPraPerSamTid_ft', 'id_kaw_kumuh' => $data['id_kaw_kumuh']));
//            $data['sis_pen_sampah_tidak_sesuai_foto'] = $this->upload_image(array('indikator_name' => 'sis_pen_sam_tid_' . substr($data['kategori'], 0, 4), 'input' => 'inpSisPenSamTid_ft', 'id_kaw_kumuh' => $data['id_kaw_kumuh']));
...
//            $data['tidak_tersedia_pras_prokeb_foto'] = $this->upload_image(array('indikator_name' => 'tid_pra_pro_keb_' . substr($data['kategori'], 0, 4), 'input' => 'inpKetPraProKeb_ft', 'id_kaw_kumuh' => $data['id_kaw_kumuh']));
//            $data['tidak_tersedia_sar_prokeb_foto'] = $this->upload_image(array('indikator_name' => 'tid_sar_pro_keb_' . substr($data['kategori'], 0, 4), 'input' => 'inpKetSarProKeb_ft', 'id_kaw_kumuh' => $data['id_kaw_kumuh']));
    ...
    public function upload_image($param) {
        $config = array(
            'upload_path' => "./assets/admin/img/foto_kawasan/",
        ...
        if ($this->input_post($param['input']) != null || $this->input_post($param['input']) != "") {
            echo $param['input'];
