                ...
                <fieldset>
                    ...
                    <form class="form-horizontal">
                        <div class="form-group">
                            ...
                            <div class="col-lg-3">
                                <textarea class="form-control" name="inpKeteraturanBangunan"></textarea>
                            </div>
                            <div class="col-lg-2">
                                Foto 1
                                <input type="file" class="form-control fileinput-button" name="inpGbr" placeholder="foto2"/>
                            </div>
                            <div class="col-lg-2">
                                Foto 2
                                <input type="file" class="form-control fileinput-button" name="inpGbr" placeholder="foto2"/>
