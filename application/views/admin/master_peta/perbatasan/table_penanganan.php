                ...
                for ($i = 1; $i <= 5; $i++) {
                    if ($perbatasan_pen['gambar' . $i] != NULL) {
                        ...
                        <div class="col-lg-6 text-center" style="padding-bottom: 10px">                                    
                            ...
                            <a href="#myModal-pen" data-toggle="modal" class="btn btn-xs btn-warning">
                                Edit
                            </a>
                        </div>
                        <?php
                        ...
                        <div class="col-lg-6" style="padding-bottom: 10px">                                    
                            ...
                            <a href="#myModal-pen" data-toggle="modal" class="btn btn-xs btn-warning btn-block">
                                Edit
                            </a>
                            <div style="display: none;" aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="myModal-pen" class="modal fade">
