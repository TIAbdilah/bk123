                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <video width="100%" controls>
                                <source src="' . base_url() . 'assets/admin/img/video/' . $data_detail_per['vid_kawasan_' . $index] . '" type="video/mp4">
        ...
        foreach ($data_indikator as $dt_ind) {
            if (substr($dt_ind->nomor, 0, 1) < 8) {
                ...
                <tr>
                    ...
                    <?php
                    if ($data_detail_per != null) {
                        if($data_detail_per[$dt_ind->field_name . '_prsn'] == null){
                            $x = '-1';
                        }else {
                            $x = $data_detail_per[$dt_ind->field_name . '_prsn'];
                        }
                        echo generate_td(
                ...
                <tr>
                    ...
                    if ($data_detail_per != null) {
                        ...
                        if ($dt_ind->nomor == '8b') {
                            ...
                            $prsn1 = $text['arc']->ya_tidak[$data_detail_per[$dt_ind->field_name . '_prsn']];
                        } else {
                            $prsn1 = $text['arc']->ada_tidak[$data_detail_per[$dt_ind->field_name . '_prsn']];
                        }
                        echo generate_td(
                                $prsn1
                                , $data_detail_per[$dt_ind->field_name . '_kt']
