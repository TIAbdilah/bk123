...
<?php
$this->load->view('admin/master/foto_kegiatan/breadcrumbs');
    ...
    <div class="col-lg-12">
        <section class="panel">
            ...
            <div class="panel-body">
                <form class="form-horizontal" role="form" enctype="multipart/form-data" action="<?php echo site_url('master/foto_kegiatan/process/edit/' . $data->id_foto) ?>" method="POST">                    
                    ...
                    <div class="form-group">
                        <div class="col-lg-offset-2 col-lg-4">
                            <img src="<?php echo base_url() . 'assets/admin/img/foto_kegiatan/' . $thumb ?>" width="120px">
                        </div>
                    </div>
                    <div class="form-group">
